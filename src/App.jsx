    ...
    <div className="cv-overlay" onClick={e => e.target.className === "cv-overlay" && onClose()}>
      <div className="cv-modal">
        ...
        <div className="cv-section">
          ...
          <div className="cv-profile">Results-driven FinTech Product Analyst and Financial Data Analyst with 5+ years of verified expertise engineering automated data systems, monitoring financial controls, and optimizing multi-million euro asset portfolios. Proven track record delivering a 45% revenue uplift at Zion Global Limited and unlocking $10M+ in new product revenue at Bostaneeeastern by integrating automated, SQL-backed quantitative decision pipelines. Currently completing a BA (Hons) in Accounting and Finance at Independent College Dublin alongside a BSc in Artificial Intelligence at Johannes Kepler University Linz, Austria. Holds 9 of 13 confirmed ACCA professional exemptions and actively preparing for the Advanced Financial Modeler (AFM) credentials. Open to specialized IFSC roles across fund administration, trade reconciliation management, and data systems architecture globally.</div>
        </div>
        ...
        <div className="cv-section">
          ...
          <div className="cv-cert-list">
            {["ACCA Professional Qualification — 9 of 13 professional exemptions confirmed","Advanced Financial Modeler (AFM) — Financial Modeling Institute · October 2026 sitting","SAP FICO — C_TS4FI certification (SAP Learning Hub)"].map(c => <div className="cv-cert" key={c}>{c}</div>)}
          </div>
        </div>
        ...
        <div className="cv-section">
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px"}}>
            {[
              ["A. Khan Ghazanfar","CEO, Bostaneeeastern","ceo@bostaneeeastern.com"],
...
function ChatTool() {
  ...
  const send=async()=>{
    ...
    const reply=await mockAIService(t);
...
function CVTool(){const [cv,setCv]=useState("");const [jd,setJd]=useState("");const [out,setOut]=useState("");const [loading,setLoading]=useState(false);const [cp,setCp]=useState(false);
  const run=async()=>{setLoading(true);setOut("");const r=await mockAIService(cv);setOut(r);setLoading(false);};
...
function CoverTool(){const [f,setF]=useState({role:"",company:"",jd:"",highlight:""});const [out,setOut]=useState("");const [loading,setLoading]=useState(false);const [cp,setCp]=useState(false);
  ...
  const run=async()=>{setLoading(true);setOut("");const r=await mockAIService(f.role);setOut(r);setLoading(false);};
        ...
        <div className="wrap">
          ...
          <div className="about-cols">
            <div>
              ...
              <p className="ap">I have 5+ years of experience across product management, financial analysis, and data systems roles. At Zion Global Limited I delivered 45% revenue uplift through AI/ML-informed roadmaps and data pipelines. At Bostaneeastern in Saudi Arabia I unlocked $10M in new revenue, conducted DCF/LBO portfolio valuations, and managed a $50M+ product portfolio. At SynCore EDU LLC I led product strategy and mentored 8+ product managers. I also hold a Diploma in Product Management from Afrihub ICT Institute. Open to IFSC roles, global fintech, and remote-first organisations worldwide — including the EU, USA, Canada, and Australia.</p>
        ...
        <div className="wrap">
          ...
          <div className="exp-list">
            {[
              ...
              {period:"May 2022 – Apr 2023",type:"Full-time · Remote",role:"Executive Product Manager & Quantitative Finance Analyst",org:"Bostaneeastern · Saudi Arabia",co:"Digital transformation and AI solutions firm serving clients across the Middle East and global markets.",bullets:["Negotiated strategic AI vendor partnerships and structured algorithmic execution frameworks that unlocked $10M in new revenue lines","Conducted advanced financial analysis, DCF/LBO portfolio valuations, and risk-adjusted revenue forecasting across a multi-million euro ($50M+) product portfolio","Built and deployed Python-based sentiment analysis models for an automated Voice-of-the-Customer programme, raising core product NPS from +32 to +65","Drove regional digital transformation by integrating automated, SQL-backed quantitative models into corporate decision pipelines, improving execution speed by 40%"]},
